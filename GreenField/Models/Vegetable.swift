...
class Vegetable: Decodable {
    ...
    required init(from decoder: any Decoder) throws {
        ...
        self.vegetableCode = try container.decode(
            String.self,
            forKey: .vegetableCode
        )
        ...
        self.thumbnailImage = try container.decode(
            URL.self,
            forKey: .thumbnailImage
        )
        self.seedDepth = try container.decode(String.self, forKey: .seedDepth)
        self.germinationSoilTemp = try container.decode(
            String.self,
            forKey: .germinationSoilTemp
        )
        self.daysToGermination = try container.decode(
            Int.self,
            forKey: .daysToGermination
        )
        self.sowIndoors = try container.decode(String.self, forKey: .sowIndoors)
        self.sowOutdoors = try container.decode(
            String.self,
            forKey: .sowOutdoors
        )
        self.phRange = try container.decode(String.self, forKey: .phRange)
        self.growingSoilTemp = try container.decode(
            String.self,
            forKey: .growingSoilTemp
        )
        self.spacingBeds = try container.decode(
            String.self,
            forKey: .spacingBeds
        )
        self.watering = try container.decode(String.self, forKey: .watering)
        self.light = try container.decode(String.self, forKey: .light)
        self.goodCompanions = try container.decode(
            String.self,
            forKey: .goodCompanions
        )
        self.badCompanions = try container.decode(
            String.self,
            forKey: .badCompanions
        )
        self.sowingDescription = try container.decodeIfPresent(
            String.self,
            forKey: .sowingDescription
        )
        self.growingDescription = try container.decode(
            String.self,
            forKey: .growingDescription
        )
        self.harvestDescription = try container.decode(
            String.self,
            forKey: .harvestDescription
        )
        ...
        self.daysToHarvestSeeds = try container.decode(
            Int.self,
            forKey: .daysToHarvestSeeds
        )
        self.daysToHarvestSeedlings = try container.decode(
            Int.self,
            forKey: .daysToHarvestSeedlings
        )
        self.healthBenefits = try container.decode(
            String.self,
            forKey: .healthBenefits
        )
    }
